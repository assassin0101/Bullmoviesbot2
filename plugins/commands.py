...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇs ✨', url='https://t.me/moonverse2023movies')
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
                    ...
                    InlineKeyboardButton('💕 ᴄʜᴀɴɴᴇʟ ✨', url='https://t.me/moonverse2023movies'),
                    InlineKeyboardButton('💖 ɢʀᴏᴜᴘ 🌺', url='https://t.me/moonverse1')
                ],[
            ...
            try:
                await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                         [
                          InlineKeyboardButton('𝐉𝐨𝐢𝐧 𝐅𝐨𝐫 𝐌𝐨𝐫𝐞 🎬', url='https://t.me/moonverse2023movies')
                         ]
                        ]
                    )
                )
        ...
        try:
            msg = await client.send_cached_media(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                     [
                      InlineKeyboardButton('ᴊᴏɪɴ ғᴏ𝟺 ᴍᴏʀᴇ 🎬', url='https://t.me/moonverse2023movies')
                     ]
                    ]
                )
            )
